...
Отчет по работе можно посмотреть в файле evaluation_report.xslx

Главная проблема ошибок состояла в том, что деление на чанки было не совсем удачным, для улучшения качества работы системы можно провести дополнительную ручную валидацию чанкированния.
Accuracy = 0.6
